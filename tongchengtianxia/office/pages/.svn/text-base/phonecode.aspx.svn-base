<%@ Page Language="VB" AutoEventWireup="false" CodeFile="phonecode.aspx.vb" Inherits="office_pages_phonecode" %>
					...
					<div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
						...
						<div class="layui-tab-content" style="min-height: 150px; padding: 5px 0 0 0; background: #fff;">
							<div class="layui-tab-item layui-show">
								<!--内容-->
								<div id="nav_name" name="手机验证码列表">
									<fieldset class="layui-elem-field">
										<legend>手机验证码列表</legend>
