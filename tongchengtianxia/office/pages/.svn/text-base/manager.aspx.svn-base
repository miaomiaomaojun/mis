<%@ Page Language="VB" AutoEventWireup="false" CodeFile="manager.aspx.vb" Inherits="office_pages_manager" %>
								...
								<div id="nav_name" name="管理员">
									<div class="admin-main layui-form">
										<div class="layui-elem-quote">
											<a href="/office/pages/addmanager.aspx" class="layui-btn layui-btn-small" id="addbank">
											...
											<table class="layui-table admin-table">
												...
												<tbody id="content">
													<tr>
														...
														<td>2017-03-05</td>
														<td>
															<a href="/office/pages/addmanager.aspx" data-opt="edit" class="layui-btn layui-btn-mini bianji">编辑</a>
															<a href="javascript:;" data-opt="edit" class="layui-btn  layui-btn-normal layui-btn-mini mima">修改密码</a>
