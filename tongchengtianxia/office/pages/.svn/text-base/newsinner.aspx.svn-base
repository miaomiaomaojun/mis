<%@ Page Language="VB" AutoEventWireup="false" CodeFile="newsinner.aspx.vb" Inherits="office_pages_newsinner" %>
									...
									<div class="admin-main layui-form">
										<div class="layui-elem-quote">
											<div class="layui-input-inline lg">
												<input type="text" name="uesrname" placeholder="请输内容" autocomplete="off" class="layui-input">
											</div>
