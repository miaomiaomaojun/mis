<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bankmanage.aspx.vb" Inherits="office_pages_bankmanage" %>
												...
												<tbody id="content">
													<tr>
														...
														<td>
															...
															<a href="javascript:;" data-opt="edit" class="layui-btn  layui-btn-danger layui-btn-mini del">删除</a></td>
													</tr>
													<tr>
														<td style="width: 30px;"><input type="checkbox" lay-skin="primary"></td>
														<td>2</td>
				...
				<div class="layui-form">
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" name="bankname" lay-verify="required" placeholder="请输入银行" autocomplete="off" class="layui-input">
						</div>
					</div>
