<%@ Page Language="VB" AutoEventWireup="false" CodeFile="addgoods.aspx.vb" Inherits="office_pages_addgoods" %>
										...
										<div class="layui-form" action="">
											<fieldset class="layui-elem-field">
												...
												<div class="layui-field-box layui-form">
													...
													<div class="layui-form-item">
														...
														<div class="layui-input-inline">
															<input type="number" name="" lay-verify="number" autocomplete="off" placeholder="请输入活动编号" class="layui-input">
														</div>
													</div>
													<div class="layui-form-item">
													...
													<div class="layui-form-item">
													    ...
													    <div class="layui-input-inline">
															<input type="text" name="shouyi" lay-verify="jiage" autocomplete="off" placeholder="¥" class="layui-input">
														</div>
													</div>
													<div class="layui-form-item">
													...
													<div class="layui-box layui-upload-button">
														<input type="file" name="file" class="layui-upload-file" id="upfm">
												...
												<div style="float: left">
													...
													<!--layui使用时去掉box和span-->
													<div class="layui-box layui-upload-button">
														<input type="file" name="file" class="layui-upload-file" id="upgo">
														<span class="layui-upload-icon"><i class="layui-icon"></i>上传图片</span>
													</div>
												</div>
													</div>
												...
												<div style="float: left">
													...
													<!--layui使用时去掉box和span-->
													<div class="layui-box layui-upload-button">
														<input type="file" name="file" class="layui-upload-file" id="uppo">
														<span class="layui-upload-icon"><i class="layui-icon"></i>上传图片</span>
													</div>
												</div>
													</div>
												...
												<div style="float: left">
													...
													<div class="layui-form-item">
														...
														<div class="layui-input-inline">
															<input type="text" name="title" lay-verify="feikongbai" autocomplete="off" placeholder="请输入商品标题" class="layui-input">
														</div>
													</div>
													<div class="layui-form-item">
														<label class="layui-form-label">简述</label>
														<div class="layui-input-block">
															<textarea name="" class="layui-textarea" lay-verify="length"></textarea>
														</div>
													</div>
													<div class="layui-form-item">
														<label class="layui-form-label">原价格</label>
														<div class="layui-input-inline">
															<input type="text" id="yuanjia" name="yuanjia" lay-verify="jiage" autocomplete="off" class="layui-input" lay-ignore>
														</div>
													</div>
													<div class="layui-form-item">
													...
													<div class="layui-form-item">
														<div class="layui-inline">
															...
															<div class="layui-input-inline">
																<input type="text" id="zengsongjifen" name="tongchengjia" lay-verify="jiage" autocomplete="off" class="layui-input" disabled>
															</div>
														</div>
													</div>
													<div class="layui-form-item">
														...
														<div class="layui-input-inline">
																<input type="text" id="kouchujifen" name="tongchengjia" lay-verify="jiage" autocomplete="off" class="layui-input" disabled>
															</div>
													</div>
													<div class="layui-form-item">
														<div class="layui-inline">
			...
			<script>
				...
				layui.use(['form', 'laypage', 'layer', 'laydate', 'layedit'], function() {
					...
					var layedit = layui.layedit;
						layedit.build('fuwenben',{'height':200}); //建立编辑器
