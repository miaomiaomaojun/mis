<%@ Page Language="VB" AutoEventWireup="false" CodeFile="addbusiness.aspx.vb" Inherits="office_pages_addbusiness" %>
                                ...
                                <div style="padding: 15px;">
                                    <div class="layui-form">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="username" lay-verify="phone" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="name" lay-verify="renming" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <select name="city" lay-filter="shoukuanfangshi" lay-verify="required">
										...
										<div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <select name="firstclass" lay-filter="leixing" lay-verify="required">
                                       ...
                                       <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <textarea id="miaoshu" style="width:100%;height: 150px;"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="file" name="title" accept="image/gif,image/jpg,image/jpeg,image/bmp,image/png" autocomplete="off" class="layui-input" style="line-height: 30px;">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="" lay-verify="feikongbai" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <select name="firstclass" lay-filter="shangquan" lay-verify="required">
