<%@ Page Language="VB" AutoEventWireup="false" CodeFile="userlist.aspx.vb" Inherits="office_pages_userlist" %>
					...
					<div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
						...
						<div class="layui-tab-content" style="min-height: 150px; padding: 5px 0 0 0;background: #fff;">
							<div class="layui-tab-item layui-show">
								<!--内容-->
								<div id="nav_name" name="普通用户列表">
									<div class="layui-form" action="">
										<div class="admin-main">
											<div class="layui-elem-quote">
												<div class="layui-input-inline">
													<input type="text" name="text" placeholder="请输入用户名称" autocomplete="off" class="layui-input">
												</div>
											...
											<table class="layui-table admin-table">
												...
												<tbody id="content">
													<tr>
														...
														<td>1</td>
														<td class="username">15751033663</td>
														<td>2017-03-02 </td>
														<td>
															<a href="javascript:;" data-opt="edit" class="layui-btn layui-btn-mini bianji">强制修改密码</a>
														</td>
													</tr>
													<tr>
														<td style="width: 30px;"><input type="checkbox" lay-skin="primary"></td>
														<td>1</td>
														<td class="username">15751033665</td>
														<td>2017-03-02 </td>
														<td>
															<a href="javascript:;" data-opt="edit" class="layui-btn layui-btn-mini bianji">强制修改密码</a>
														</td>
													...
													<tr>
														<td style="width: 30px;"><input type="checkbox" lay-skin="primary"></td>
														<td>1</td>
														<td class="username">15751033666</td>
														<td>2017-03-02 </td>
														<td>
															<a href="javascript:;" data-opt="edit" class="layui-btn layui-btn-mini bianji">强制修改密码</a>
														</td>
					...
					$(".bianji").on('click', function() {
						...
						bjBoxIndex = layer.open({
							...
							success: function(layero, index) {
								...
								var form = layui.form();
								form.render();
								$("#tanchuang").find("input[name='username']").val(username);
			...
			<div style="display:none;margin: 15px;" id="tanchuang">
				<div class="layui-form">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="password" name="password" id="mima" lay-verify="mima" placeholder="请输入密码" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">确认密码</label>
						<div class="layui-input-inline">
							<input type="password" name="password" lay-verify="mimaqueren" placeholder="请输入密码" autocomplete="off" class="layui-input">
						</div>
					</div>
