<%@ Page Language="VB" AutoEventWireup="false" CodeFile="businesslist.aspx.vb" Inherits="office_pages_businesslist" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head id="Head1" runat="server">
		...
		<style>
			td.mentou img{width: 60px;height: 50px;}
			td.erweima img{width: 50px;height: 50px;}
		</style>
	</head>
								...
								<div id="nav_name" name="商家列表">
									<div class="admin-main layui-form">
										<div class="layui-elem-quote">
											...
											<a href="/office/pages/addbusiness.aspx" class="layui-btn layui-btn-small" id="add">
											...
											<table class="layui-table admin-table">
												...
												<tbody id="content">
													<tr>
														...
														<td>李老三</td>
														<td>0516-8877888</td>
														<td>徐州市泉山区黄河北路90号淮海文化科技产业园</td>
														<td>银行卡</td>
														<td>6210983320101851007</td>
														<td>张三</td>
														<td>美食</td>
														<td>火锅</td>
														<td>不限</td>
														<td class="mentou"><img src="" alt="" /></td>
														<td class="erweima"><img src="" alt="" /></td>
														<td>煌上煌火锅</td>
														<td>彭城壹号</td>
													</tr>
													<tr>
