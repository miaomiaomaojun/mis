<%@ Page Language="VB" AutoEventWireup="false" CodeFile="projectmanage.aspx.vb" Inherits="office_pages_projectmanage" %>
					...
					<div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
						...
						<div class="layui-tab-content" style="min-height: 150px; padding: 5px 0 0 0; background: #fff;">
							<div class="layui-tab-item layui-show">
								<!--内容-->
								<div id="nav_name" name="内页类目管理">
									<div class="admin-main layui-form">
										<div class="layui-elem-quote">
											<a href="javascript:;" class="layui-btn layui-btn-small" id="addinner">
												<i class="layui-icon">&#xe608;</i> 添加内页
											</a>
										</div>
											...
											<table class="layui-table admin-table">
												...
												<tbody id="content">
													<tr>
														...
														<td>公司公告</td>
														<td>
															<a href="javascript:;" data-opt="edit" class="layui-btn  layui-btn-mini bianji">修改</a>
			...
			<script>
			    ...
			    layui.use(['form', 'laypage', 'layer', "laydate"], function () {
			        ...
			        $(".bianji").on('click', function () {
                        ...
                        var str=$(this).parent("td").prev().html();
			...
			<div style="display:none;margin: 15px;" id="tanchuang">
				<div class="layui-form">
					<div class="layui-form-item">
						<label class="layui-form-label">内页名称</label>
						<div class="layui-input-inline">
							<input type="text" name="innername" lay-verify="required" placeholder="请输入内页名称" autocomplete="off" class="layui-input">
						</div>
					</div>
