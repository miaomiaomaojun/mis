<%@ Page Language="VB" AutoEventWireup="false" CodeFile="order_manage.aspx.vb" Inherits="bussiness_office_pages_order_manage" %>
													...
													<table class="layui-table" lay-skin="line">
														...
														<tbody id="content">
															<tr>
																...
																<td>1234567891234567891234567</td>
																<td>tc123456789123456789</td>
																<td>2017-04-07 14:36</td>
																<td>沈场砂锅麻辣烫30元代金券1张，免预约</td>
																<td>1</td>
																<td>20</td>
																<td>已消费</td>
																<td>
																	<div>
																		<a href="javascript:;" data-opt="edit" class="layui-btn layui-btn-mini chuli">查看</a>
																	</div>
																</td>
															</tr>
														</tbody>
